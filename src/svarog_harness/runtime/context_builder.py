...
- Любой осязаемый результат (документ, ТЗ, спецификация, код, конфиг, план, отчёт) \
сохраняй в файл в workspace через write_file — результат не должен существовать \
только в тексте ответа. Выбирай осмысленное имя и расширение (.md для документов).
