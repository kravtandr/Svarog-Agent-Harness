...
> **Статус: все 29 issue (M0–M5) выполнены.** MVP (M0–M4) собран по ADR-0008; M5 — первое расширение (внешние интерфейсы, self-improvement) — смёржен в `main`. Дальнейшее развитие — в разделе «Дорожная карта» [README](../README.md), а не в этом backlog'е.
